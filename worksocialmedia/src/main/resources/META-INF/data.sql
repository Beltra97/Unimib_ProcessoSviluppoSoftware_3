...
CREATE TABLE company (id INT AUTO_INCREMENT  PRIMARY KEY, name VARCHAR(250) NOT NULL, CEO VARCHAR(250) NOT NULL, number_employees INT(20) NOT NULL, foundation_year VARCHAR(250) NOT NULL, description VARCHAR(500) NOT NULL);
