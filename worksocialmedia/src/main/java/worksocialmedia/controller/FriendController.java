...
public class FriendController {
  ...
  public String friendAdd(@RequestParam(value="addUser1") Long user1Id, @RequestParam(value="addUser2") Long user2Id, @RequestParam(value="addCreationDate") String creationDate) {
  ...
  public String friendUpdate(@PathVariable("id") Long id, @RequestParam(value="updateCreationDate") String creationDate) {
