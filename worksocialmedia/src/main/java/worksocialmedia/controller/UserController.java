...
public class UserController {
	...
	@PostMapping("adduser")
	public String userAdd(@RequestParam(value = "addFirstName") String firstName,
			@RequestParam(value = "addLastName") String lastName, @RequestParam(value = "addGender") String gender,
			@RequestParam(value = "addBirthDate") String birthDate,
			@RequestParam(value = "addResidentialAddressId") Long userAddressId) {
	...
	public String userUpdate(@PathVariable("id") Long id, @RequestParam(value = "updateFirstName") String firstName,
			@RequestParam(value = "updateLastName") String lastName,
			@RequestParam(value = "updateGender") String gender,
			@RequestParam(value = "updateBirthDate") String birthDate) {
