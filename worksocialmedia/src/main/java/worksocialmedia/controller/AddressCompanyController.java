...
public class AddressCompanyController {
  ...
  public String companyAddressAdd(@RequestParam(value="addStreet") String street, @RequestParam(value="addMunicipality") String municipality, @RequestParam(value="addCivicNumber") String civicNumber, @RequestParam(value="addPostalCode") String postalCode, @RequestParam(value="addNation") String nation) {
